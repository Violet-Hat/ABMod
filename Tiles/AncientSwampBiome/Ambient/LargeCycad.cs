...
{
    public class LargeCycad : ModTile
    {
        //Texture
        ...
        public override bool PreDraw(int i, int j, SpriteBatch spriteBatch)
        {
			...
			{
				Main.spriteBatch.Draw(PlantTexture.Value, pos, new Rectangle(0, 0, 96, 92), new Color(col.R, col.G, col.B, 255), 0f, offset, 1f, SpriteEffects.None, 0f);
			}
