...
{
	public class ScaleDresser : ModTile
	{
		public override void SetStaticDefaults()
		{
            ...
            AddMapEntry(new Color(96, 109, 78), this.GetLocalization("MapEntry"), MapChestName);
		...
		public override void MouseOverFar(int i, int j)
		{
			...
			else
			{
				...
				{
					player.cursorItemIconText = "Scalewood Dresser";
				}
				if (player.cursorItemIconText == "Scalewood Dresser")
				{
					player.cursorItemIconID = ModContent.ItemType<ScaleDresserItem>();
