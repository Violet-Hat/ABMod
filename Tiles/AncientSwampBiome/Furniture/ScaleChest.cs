...
{
    [LegacyName("ScaleChest2")]
	[LegacyName("ScaleChest3")]
	[LegacyName("ScaleChest4")]
	public class ScaleChest : ModTile
	{
		public override void SetStaticDefaults()
		{
			...
			RegisterItemDrop(ModContent.ItemType<ScaleChestItem>());
		...
		public override void MouseOver(int i, int j)
		{
			...
			else
			{
				...
				{
					player.cursorItemIconID = ModContent.ItemType<ScaleChestItem>();
