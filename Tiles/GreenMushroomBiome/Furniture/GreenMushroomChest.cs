...
{
    [LegacyName("GreenMushroomChest2")]
	[LegacyName("GreenMushroomChest3")]
	[LegacyName("GreenMushroomChest4")]
	public class GreenMushroomChest : ModTile
	{
		public override void SetStaticDefaults()
		{
			...
			RegisterItemDrop(ModContent.ItemType<GreenMushroomChestItem>());
		...
		public override void MouseOver(int i, int j)
		{
			...
			else
			{
				...
				{
					player.cursorItemIconID = ModContent.ItemType<GreenMushroomChestItem>();
