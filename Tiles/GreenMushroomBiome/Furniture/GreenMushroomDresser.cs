...
{
	public class GreenMushroomDresser : ModTile
	{
		public override void SetStaticDefaults()
		{
            ...
            AddMapEntry(new Color(13, 91, 44), this.GetLocalization("MapEntry"), MapChestName);
		...
		public override void MouseOverFar(int i, int j)
		{
			...
			else
			{
				...
				{
					player.cursorItemIconText = "Green Mushroom Dresser";
				}
				if (player.cursorItemIconText == "Green Mushroom Dresser")
				{
					player.cursorItemIconID = ModContent.ItemType<GreenMushroomDresserItem>();
