...
{
	public class CentralAsteroid : Asteroid
	{		
		public override bool Place(Point origin, StructureMap structures)
		{
			int size = WorldGen.genRand.Next(29, 35);
		...
		public override void generateAsteroid(Point origin, int size)
		{
			...
			for(int i = 0; i < rockRand; i++)
			{
				...
				WorldGen.TileRunner(coordinates.X, coordinates.Y, WorldGen.genRand.NextFloat(4f, 9f), WorldGen.genRand.Next(10, 20), AsteroidRock);
			}
