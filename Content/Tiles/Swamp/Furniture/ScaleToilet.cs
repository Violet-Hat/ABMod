...
{
    public class ScaleToilet : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            AddMapEntry(new Color(96, 109, 78), Language.GetText("MapObject.Toilet"));
        ...
        public override void MouseOver(int i, int j)
		{
			...
			player.cursorItemIconID = ModContent.ItemType<ScaleToiletItem>();
